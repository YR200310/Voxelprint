...
export class CheckboxComponent extends ConfigComponent<boolean, HTMLSelectElement> {
    private _checked: { type: 'localised', key: string } | { type: 'unlocalised', text: string };
    private _unchecked: { type: 'localised', key: string } | { type: 'unlocalised', text: string };
    ...
    public setCheckedText(key: string) {
        this._checked = {
    ...
    public setUncheckedText(key: string) {
        this._unchecked = {
            type: 'localised', key: key,
        };
        return this;
